...
%define major        8
%define minor        8
%define rocky_rel    7%{?rllh:.%{rllh}}%{!?rllh:.0}
...
Conflicts:      ciq-rocky88-repos%{?rltype}

%description -n ciq-rocky88-cloud-repos%{?rltype}
...
install -p -m 0644 %{SOURCE1350} %{buildroot}%{_sysconfdir}/yum.repos.d/
...
%files -n ciq-rocky88-cloud-repos%{?rltype}
%license LICENSE
...
# supersede it.
%posttrans -n ciq-rocky88-cloud-repos%{?rltype}
...
%preun -n ciq-rocky88-cloud-repos%{?rltype}
...
%changelog
* Wed Jun 25 2025 Trinity Quirk <tquirk@ciq.com> - 8.8-7.0
- Add support for AWS cloud mirroring

* Fri May 02 2025 Trinity Quirk <tquirk@ciq.com> - 8.8-6.0
- Add CIQ signing key
